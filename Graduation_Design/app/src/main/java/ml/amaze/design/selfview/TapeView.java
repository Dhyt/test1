...
public class TapeView extends View {
    ...
    private float calibrationWidth = 1.0f;

    //短的刻度线的高度dp

    private float calibrationShort = 20;

    //长的刻度线的高度dp

    private float calibrationLong = 35;
    //dp
