...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recipepart_food);

/*
        et = (EditText) findViewById(R.id.food_et_foodName);
        //把edittext的回车变成搜索键
...
*/
        lv = (ListView) findViewById(R.id.food_lv_search);
        // ListView滑动时触发的事件
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view;
            if (convertView == null) {
                view = View.inflate(FoodActivity.this, R.layout.recipepart_items_entity1, null);
            ...
            Glide.with(getApplicationContext()).load(path).override(100, 100).fitCenter().into(searchItemIv);
    ...
    public void cacheBit(Entity1 entity1) {
        ...
        for (Entity1.FoodsBean food : list) {
            try {
                ...
                file = new File(getCacheDir().getAbsolutePath() + "/" + "mid" + path.substring(path.lastIndexOf("/") + 1));
