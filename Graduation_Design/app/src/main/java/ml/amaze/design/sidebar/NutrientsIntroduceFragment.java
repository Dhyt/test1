...
public class NutrientsIntroduceFragment extends Fragment {
    private String[] namezhcn = { "蛋白质", "脂肪", "碳水化合物", "膳食纤维", "维生素A", "维生素C", "维生素E", "胡萝卜素", "维生素B1", "维生素B2", "烟酸", "胆固醇", "镁", "钙", "铁", "锌", "铜", "锰", "钾", "磷", "钠", "硒"};
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        view=inflater.inflate(R.layout.sidebar_nutrients_introduce,null);

        ListView lv = (ListView) view.findViewById(R.id.sidebar_nutrients_introduce_lv);
    ...
    private class MyAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view;
            if (convertView == null) {
                view = View.inflate(getActivity(), R.layout.sidebar_nutrients_introduce_items, null);
            } else {
                view = convertView;
            }

            TextView name = (TextView) view.findViewById(R.id.sidebar_nutrients_introduce_items_name);
            TextView introduce = (TextView) view.findViewById(R.id.sidebar_nutrients_introduce_items_introduce);

            name.setText(namezhcn[position]);
            introduce.setText(lights[position]);
            return view;
        }
    }
